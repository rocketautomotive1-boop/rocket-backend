 ...
 *
 * IMPORTANTE: os métodos de escrita deste adapter (createNewProduct/updateExistingProduct)
 * NÃO são o caminho real de publicação em produção — confirmado ao vivo (2026-09-11) que
 * quem publica de fato no ML é microservices/orchestrator/src/workers/ml/mercadolivre-sync.worker.ts.
 * Não adicionar lógica de negócio nova aqui (ex.: sync de compatibilidades) — ela nunca roda.
 */
